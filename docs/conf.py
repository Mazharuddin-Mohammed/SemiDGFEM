...
htmlhelp_basename = 'SemiDGFEMdoc'
...
latex_documents = [
    (master_doc, 'SemiDGFEM.tex', 'SemiDGFEM Documentation',
...
man_pages = [
    (master_doc, 'semidgfem', 'SemiDGFEM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SemiDGFEM', 'SemiDGFEM Documentation',
     author, 'SemiDGFEM', 'High Performance TCAD Software using Discontinuous Galerkin FEM.',
     'Miscellaneous'),
]
